module.exports = function (lnwebcli) {
	...
	lnwebcli.controller("GetInfoCtrl", ["$scope", "$timeout", "$window", "lncli", "config", require("./getinfo")]);
	...
	lnwebcli.controller("ListPeersCtrl", ["$scope", "$timeout", "$uibModal", "jQuery", "bootbox", "lncli", "config", require("./listpeers")]);
