module.exports = function (lncli, config, utils) {
  return {
    ...
    transclude: false,
    scope: {
      baseValue: '=?baseValue', baseUnit: '=?baseUnit', mainUnit: '=?mainUnit', altUnit: '=?altUnit',
    },
        ...
        if (!attrs.baseUnit || (attrs.baseUnit === 'sat')) {
          ...
          if (mainUnit) {
            ...
            switch (mainUnit) {
              ...
              case 'usd':
              case 'eur':
                lncli.getCoinPrice(true, mainUnit).then((price) => {
          ...
          if (altUnit) {
            ...
            switch (altUnit) {
              ...
              case 'usd':
              case 'eur':
                lncli.getCoinPrice(true, altUnit).then((price) => {
